...
class ObjectHandler:
    def __init__(self, game):
        ...
        self.static_sprite_path = 'GameForIA/resources/sprites/static_sprites/'
        self.anim_sprite_path = 'GameForIA/resources/sprites/animated_sprites/'
        ...
        # add_sprite(AnimatedSprite(game, path=self.anim_sprite_path + 'grandfather_cock/0.png', pos=(14.5, 12.5)))
        # add_sprite(AnimatedSprite(game, path=self.anim_sprite_path + 'grandfather_cock/0.png', pos=(9.5, 20.5)))
        # add_sprite(AnimatedSprite(game, path=self.anim_sprite_path + 'grandfather_cock/0.png', pos=(10.5, 20.5)))
        # add_sprite(AnimatedSprite(game, path=self.anim_sprite_path + 'grandfather_cock/0.png', pos=(3.5, 14.5)))
        # add_sprite(AnimatedSprite(game, path=self.anim_sprite_path + 'grandfather_cock/0.png', pos=(3.5, 18.5)))
